...
class MatMulInt4OpConverter : public OpConverter {
 public:
  void operator()(const framework::proto::OpDesc& op,
    ...
    // fields.emplace_back("dims_x", &dims_x, nvinfer1::PluginFieldType::kDIMS,
    // 1); fields.emplace_back("dims_y", &dims_y,
    ...
    // auto creator =
    //     GetPluginRegistry()->getPluginCreator("MatmulInt4PluginCreator",
    //     "1");
